...
public class Terminal {
    ...
    protected S3270 s3270;
    public static final Collection<TerminalObserver> observers = new ArrayList<TerminalObserver>();
    ...
    protected void commandIssued(String command, String returned, Parameter... parameters) {
        for (TerminalObserver observer : observers) {
    ...
    protected Parameter[] buildParameters(FieldIdentifier fieldIdentifier, String value) {
